 ...
 */
public class NoteCursorAdapter2 extends BaseAdapter {
     ...
     */
    public NoteCursorAdapter2(Context context, @Nullable NoteCursor cursor,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // If the old view is already mapped to the given note, skip binding.
        if (convertView != null) {
            if (bindingMap.containsKey(convertView) &&
                    bindingMap.get(convertView) == note.getId()) {
                Log.d(TAG, "Given view is already mapped to the correct note;"
                        + " returning it.");
                return convertView;
            }
            ...
            noteView = (TextView) inflater.inflate(R.layout.list_item,
                    parent, false);
        }
        ...
        bindingMap.put(noteView, note.getId());
